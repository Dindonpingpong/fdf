...
/*   Updated: 2019/12/14 18:25:09 by rkina            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// gcc -I minilibx -L minilibx -lmlx -framework OpenGL -framework Appkit main.c check_valid.c draw_map.c create_map.c key_and_mouse_press.c atoi_hex.c libft/libft.a
...
int			main(int argc, char **argv)
{
	...
	if (argc == 2)
	{
		...
		map_struct->move_y = 400;
		map_struct->move_x = 400;
